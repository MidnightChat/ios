...
# $TARGET_BUILD_DIR = ~/Library/Developer/Xcode/DerivedData/Midnightios-eqpxjmfeshykdhenvfigilydnzgz/Build/Products/Debug-iphonesimulator
# $INFOPLIST_PATH = Midnightios.app/Info.plist
target_plist="$TARGET_BUILD_DIR/$INFOPLIST_PATH"
# $DWARF_DSYM_FOLDER_PATH = ~/Library/Developer/Xcode/DerivedData/Midnightios-eqpxjmfeshykdhenvfigilydnzgz/Build/Products/Release-iphoneos
# $DWARF_DSYM_FILE_NAME = Midnightios.app.dSYM
